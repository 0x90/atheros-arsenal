...
#define JALDI_TXQ_USEDEFAULT ((u32) -1)
#define JALDI_TXQ_USE_LOCKOUT_BKOFF_DIS 0x00000001
...
struct jaldi_tx_queue_info {
	u32 tqi_ver;
	enum jaldi_tx_queue tqi_type;
	enum jaldi_tx_queue_type tqi_subtype;
	enum jaldi_tx_queue_flags tqi_qflags;
	u32 tqi_priority;
	u32 tqi_aifs;
	u32 tqi_cwmin;
	u32 tqi_cwmax;
