 ...
 * 
 * JaldiMAC modifications:
 * - Renamed functions
 * - Changed includes to point to what we care about
 * - Removed update_regulatory... 
 */
...
struct eeprom_ops {
	...
	u32 (*get_eeprom)(struct jaldi_hw *hw, enum eeprom_param param);
